...
export function openDailyReview(dateStr) {
    ...
    // Adicionado um ID único para cada item da lista (Prioridade 2)
...
export function startFlashcardFromDash(id) {
    // Esvazia a lista para que o sistema saiba que viemos de um atalho direto
...
export function handleDifficulty(level) {
    ...
    // Remove dinamicamente o versículo concluído da interface (Prioridade 2)
