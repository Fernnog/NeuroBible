...
// --- [CORREÇÃO P1] INJEÇÃO DE FUNÇÕES DE MODAL AUSENTES ---
...
export function confirmSmartReschedule() {
    ...
    // Realoca dia a dia, respeitando o teto de carga
    data.dates.forEach(d => {
        ...
        loadMap[searchDate] = (loadMap[searchDate] || 0) + 1; // Atualiza o mapa temporal
    });
